     ...
     <body>
      <div class="mws-panel grid_8"> 
       <div class="mws-panel-header"> 
        <span><i class="icon-table"></i>已审核友情链接列表</span> 
       </div> 
       <div class="mws-panel-body no-padding"> 
        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">

        <!-- 搜索开始 -->
        <form action="/friendslink" method="get">
         ...
         <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
          <thead> 
           <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 137px;">上架/下架</th>
          ...
          <tbody role="alert" aria-live="polite" aria-relevant="all">
           ...
           <tr class="odd"> 
            ...
            <td class=" ">
              <form action="/friendslinkDelVerifyPass/{{$row->id}}" method="">
                
                <button class="btn btn-inverse" onclick="return confirm('确定删除该链接吗?');"><i class="icon-remove"></i></button>
                
              </form>

              <a href="/friendslink/{{$row->id}}/edit" class="btn btn-info"><i class="icon-edit"></i></a>
            </td> 
           </tr>
           @endforeach
           @endif
