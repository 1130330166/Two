  ...
  <div class="container padding-top-1x padding-bottom-3x"> 
   <div class="row"> 
    ...
    <div class="col-md-12">
      ...
      <h3 class="margin-bottom-1x padding-top-1x">编辑收货地址</h3>
      
      @if(!empty($info))
      <form action="/homeaddress/{{$info->id}}" class="row" method="post">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label>收件人</label>
                <input class="form-control" type="text" name="aname" value="{{$info->aname}}">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label>邮编</label>
                <input class="form-control" type="text" name="postalcode" maxlength="6" value="{{$info->postalcode}}" />
            </div>
        </div>
        ...
        <div class="col-12 text-center text-sm-right">
            <button class="btn btn-outline-success margin-bottom-none" type="submit">保存</button>
            <button class="btn btn-outline-primary margin-bottom-none" type="reset">重置</button>
        </div>
        {{method_field("PUT")}}
        {{csrf_field()}}
      </form>
