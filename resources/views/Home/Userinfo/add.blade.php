    ...
    <div class="container padding-top-1x padding-bottom-3x"> 
     <div class="row"> 
       ...
       <aside class="user-info-wrapper"> 
        ...
        <div class="user-info"> 
         <div class="user-avatar">
          ...
          <img src="/static/assets/images/account/default.png" alt="User" />
         </div> 
         <div class="user-data"> 
      ...
      <div class="col-lg-8"> 
       ...
       <form class="row" action="homeuserinfo" method="post"> 

        <div class="col-md-6"> 
         <div class="form-group"> 
          <label>真实姓名</label> 
          <input class="form-control" type="text" value="" required="" name="rname" /> 
         </div> 
        </div> 
        ...
        <div class="col-md-6"> 
         <div class="form-group"> 
          <label>年龄</label> 
          <input class="form-control" type="text" value="" required="" name="age" /> 
         </div> 
        </div> 
        ...
        <div class="col-md-6"> 
         <div class="form-group"> 
          <label>手机号</label> 
          <input class="form-control" type="text" name="telphone" maxlength="11" /> 
         </div> 
        </div> 
        ...
        <div class="col-md-6"> 
         <div class="form-group"> 
          <label>家庭住址</label> 
          <input class="form-control" type="text" name="raddress" value="" /> 
         </div> 
        </div> 
